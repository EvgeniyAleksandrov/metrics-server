...
func (a *Memory) GetAll(r resource.Resource) ([]*metric.Metric, error) {
	...
	return []*metric.Metric{
		...
		metric.NewMetric(metric.Frees, types.Gauge(memStats.Frees)),
		...
		metric.NewMetric(metric.Lookups, types.Gauge(memStats.Lookups)),
		...
		metric.NewMetric(metric.Mallocs, types.Gauge(memStats.Mallocs)),
		metric.NewMetric(metric.NextGC, types.Gauge(memStats.NextGC)),
		metric.NewMetric(metric.NumForcedGC, types.Gauge(memStats.NumForcedGC)),
		metric.NewMetric(metric.NumGC, types.Gauge(memStats.NumGC)),
		metric.NewMetric(metric.OtherSys, types.Gauge(memStats.OtherSys)),
		metric.NewMetric(metric.PauseTotalNs, types.Gauge(memStats.PauseTotalNs)),
		...
		metric.NewMetric(metric.TotalAlloc, types.Gauge(memStats.TotalAlloc)),
	}, nil
}
